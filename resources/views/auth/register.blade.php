@extends('layouts.app', [
    'class' => 'register-page',
    'backgroundImagePath' => 'img/bge.jpg'
])
                ...
                <div class="col-lg-5 col-md-5 ml-auto">
                    <div class="info-area info-horizontal mt-5">
                        ...
                        <div class="description">
                            ...
                            <p class="description">
                                Keeping records of all employees
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">Employee Leave Management</h5>
                            <p class="description">
                               Keeping track of leave applications
                            </p>
                        </div>
                    </div>
                    <div class="info-area info-horizontal">
                        ...
                        <div class="description">
                            <h5 class="info-title">Data Presentation</h5>
                            <p class="description">
                               Presentation of employee data using Graphs, Pie charts, etc.
                            </p>
                        </div>
                    </div>
                </div>
